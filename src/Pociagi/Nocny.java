...
public class Nocny extends Pociag implements Rezerwacja, Zakupione {
    private HashMap<String, Bilet> zakupione = new HashMap<String, Bilet>();
    private HashMap<String, Bilet> rezerwacja = new HashMap<String, Bilet>();

    public Nocny(int id, String nazwa, int dlugoscSkladu, int ladownosc, double predkoscMax) {
